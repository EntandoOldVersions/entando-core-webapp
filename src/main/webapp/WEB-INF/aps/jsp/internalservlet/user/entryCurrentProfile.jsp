...
<c:choose>
	<c:when test="${sessionScope.currentUser != 'guest'}">
		...
		<form 
			action="<wp:action path="/ExtStr2/do/Front/CurrentUser/Profile/save.action" />" 
			method="post" 
			...
			<div class="control-group public-profile">
				...
				<label class="control-label" for="userprofile_publicValue"><wp:i18n key="userprofile_PUBLICCHECK" /></label>
				<div class="controls">
					<wpsf:checkbox 
						useTabindexAutoIncrement="true" 
						name="publicProfile" 
						id="userprofile_publicValue" 
			...
			<p class="form-actions">
				...
				<wpsf:submit 
					useTabindexAutoIncrement="true" 
					value="%{#attr.userprofile_SAVE_PROFILE}" 
