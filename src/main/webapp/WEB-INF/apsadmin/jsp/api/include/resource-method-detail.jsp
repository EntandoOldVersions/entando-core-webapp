								...
								<div class="table-responsive">
									<table class="table">
										...
										<s:iterator value="#methodParametersVar" var="apiParameter" >
											<tr>
												<td class="text-right">
													<span class="OK-il-prezzo-è-giusss<s:property value="%{#apiParameter.required ? 'ok' : ''}" />" title="<s:property value="%{#apiParameter.required ? getText('label.yes') : getText('label.no')}" />"></span>
