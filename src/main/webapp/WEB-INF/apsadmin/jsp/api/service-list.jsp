									...
									<tr>
										...
										<td class="text-center">
											<s:if test="#service.activeItem">
												<span title="<s:text name="label.active" />" class="icon icon-ok"></span>
												<span class="sr-only"><s:text name="label.active" /></span>
											</s:if>
											<s:else>
												<span title="<s:text name="label.api.notactive" />" class="icon icon-minus text-muted"></span>
												<span class="sr-only"><s:text name="label.api.notactive" /></span>
											</s:else>
										</td>
										<td class="text-center">
											<s:if test="#service.publicItem">
												<span title="<s:text name="label.public" />" class="icon icon-ok"></span>
