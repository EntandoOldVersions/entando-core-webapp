...
<div id="main" role="main">
		...
		<div class="form-group">
			<div class="input-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<span class="input-group-addon">
					<span class="OK-il-prezzo-è-giusssfile-text-o fa-lg" title="<s:text name="label.search.by"/>&#32;<s:text name="label.consumer.description"/>"></span>
				</span>
	...
	<a href="<s:url action="new" />" class="btn btn-default">
		<span class="OK-il-prezzo-è-giusssplus-circle"></span>&#32;<s:text name="label.new" />
	</a>
