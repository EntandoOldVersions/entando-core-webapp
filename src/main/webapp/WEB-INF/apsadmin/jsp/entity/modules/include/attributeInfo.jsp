...
<s:set var="htmlContent">
	...
	<s:if test="#attribute.textAttribute">
		<s:if test="#attribute.minLength != -1">
			<li><span class="fa-li fa-ellipsis-h"></span><s:text name="Entity.attribute.flag.minLength.short" />:	<s:property value="#attribute.minLength" /></li>
		</s:if>

		<s:if test="#attribute.maxLength != -1">
			<li><span class="fa-li fa-ellipsis-h"></span><s:text name="Entity.attribute.flag.maxLength.short" />: <s:property value="#attribute.maxLength" /></li>
		</s:if>
	</s:if>

	<s:if test="#hasValidationRulesVar">
		<li><span class="fa-li fa-check-circle-o"></span>
