		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<s:if test="null != references['GuiFragmentManagerUtilizers']">
					<wpsa:subset source="references['GuiFragmentManagerUtilizers']" count="10" objectName="guiFragReferences" advanced="true" offset="5" pagerId="pageManagerReferences">
						<s:set name="group" value="#guiFragReferences" />
							...
							<table class="table table-bordered" id="guiFragListTable">
								...
								<s:iterator var="currentGuiFragmentVar">
									<tr>
										...
										<td>
											<s:property value="#currentGuiFragmentVar.code" />
										</td>
									</tr>
								</s:iterator>
							</table>
			...
			<div class="panel-heading">
				...
				<div class="panel-body">
					<s:if test="null != references['PageModelManagerUtilizers']">
						<wpsa:subset source="references['PageModelManagerUtilizers']" count="10" objectName="pageModelRegerences" advanced="true" offset="5" pagerId="userManagerReferences">
							<s:set name="group" value="#pageModelRegerences" />
							<div class="text-center">
								<s:include value="/WEB-INF/apsadmin/jsp/common/inc/pagerInfo.jsp" />
								<s:include value="/WEB-INF/apsadmin/jsp/common/inc/pager_formBlock.jsp" />
							</div>
								...
								<table class="table table-bordered" id="userListTable">
									...
									<s:iterator var="pageModelVar">
										<tr class="text-center text-nowrap">
											...
											<td>
												<s:property value="#pageModelVar.code" />
											</td>
											<td>
