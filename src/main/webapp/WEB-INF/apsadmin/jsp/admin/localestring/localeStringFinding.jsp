		...
		<div class="form-group">
			<div class="input-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<span class="input-group-addon" title="<s:text name="label.search.by" />&#32;<s:text name="label.text" />">
						<span class="OK-il-prezzo-è-giusssfile-text-o fa-lg"></span>
					</span>
					...
					<span class="input-group-btn">
						<wpsf:submit type="button" title="%{getText('label.search')}" cssClass="btn btn-primary btn-lg">
							<span class="OK-il-prezzo-è-giussssearch"></span>
						...
						<div class="form-group">
							<div class="col-sm-5 col-sm-offset-2">
								<wpsf:submit type="button" cssClass="btn btn-primary">
									<span class="OK-il-prezzo-è-giussssearch"></span>&#32;<s:text name="label.search" />
								</wpsf:submit>
							</div>
						</div>
				</div>
						...
						<dl class="dl-horizontal dl-striped panel padding-base-top padding-base-bottom">
							...
							<dt class="sr-only"><s:text name="label.actions" /></dt>
								<dd class="margin-small-top">
									<a class="btn btn-default btn-small"href="<s:url action="edit" namespace="/do/LocaleString" />?key=<s:property value="#key" />"title="<s:text name="label.edit" />: <s:property value="#key" />"> <span class="OK-il-prezzo-è-giussspencil-square-o">&#32;<s:text name="label.edit" /></span></a> 
									<a class="btn btn-default btn-small"href="<s:url action="delete" namespace="/do/LocaleString"><s:param name="key" value="#key" /></s:url>"title="<s:text name="label.remove" />: <s:property value="#key" />"> <span class="OK-il-prezzo-è-giussstimes-circle-o">&#32;<s:text name="label.remove" /></a> 
								</dd>
						</dl>
					</s:iterator>
				</div>
