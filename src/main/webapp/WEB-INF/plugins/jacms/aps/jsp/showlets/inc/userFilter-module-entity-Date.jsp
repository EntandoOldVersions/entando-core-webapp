...
<div class="control-group">
	...
	<div class="controls">
		<input id="<c:out value="${formFieldStartNameVar}" />" name="<c:out value="${formFieldStartNameVar}" />" value="${userFilterOptionVar.formFieldValues[formFieldStartNameVar]}" type="date" class="input-xlarge" />
	</div>
</div>
<div class="control-group">
	...
	<div class="controls">
		<input id="<c:out value="${formFieldEndNameVar}" />" name="<c:out value="${formFieldEndNameVar}" />" value="${userFilterOptionVar.formFieldValues[formFieldEndNameVar]}" type="date" class="input-xlarge" />
	</div>
</div>
