	...
	<s:if test="#attribute.symbolicLink != null">
		...
		<s:if test="#validLink">
			...
			<s:if test="#attribute.symbolicLink.destType == 1">
				<s:set var="statusIconVar">btn btn-default disabled icon icon-globe</s:set>
			...
			<s:if test="#attribute.symbolicLink.destType == 2">
				<s:set var="statusIconVar">btn btn-default disabled icon icon-folder-close</s:set>
			...
			<s:if test="#attribute.symbolicLink.destType == 3">
				<s:set var="statusIconVar">btn btn-default disabled icon icon-file-text-alt</s:set>
			...
			<s:if test="#attribute.symbolicLink.destType == 4">
				<s:set var="statusIconVar">btn btn-default disabled icon icon-file-text</s:set>
