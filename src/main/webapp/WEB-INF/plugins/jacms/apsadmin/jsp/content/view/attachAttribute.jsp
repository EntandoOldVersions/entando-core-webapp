...
<s:if test="#lang.default"><%-- default language --%>
	<s:if test="#currentResource != null">
		<a title="<s:text name="label.download" />: <s:property value="#defaultResource.instance.fileName" />" href="<s:property value="#defaultResource.attachPath" />" class="btn btn-default"><span class="fa fa-download"></span><span class="sr-only"><s:text name="label.download" /></span></a>
		&#32;
...
<s:else><%-- other languages --%>
	...
	<s:else>
		<s:if test="#currentResource != null">
			...
			<span class="fa fa-download"></span><span class="sr-only"><s:text name="label.download" /></span></a>
			&#32;
		...
		<s:else>
			...
			<span class="fa fa-download text-muted"></span><span class="sr-only"><s:text name="label.download" /></span></a>
			&#32;
