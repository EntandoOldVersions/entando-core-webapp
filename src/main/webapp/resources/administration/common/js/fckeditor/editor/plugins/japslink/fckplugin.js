 ...
 * Plugin to insert "Entandolink" in the editor.
...
window.open(applicationBasePath+'do/jacms/Content/Hypertext/configInternalLink.action','','width=800,location=no,scrollbars=yes,toolbar=no');
}
