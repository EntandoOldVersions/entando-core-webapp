...
<%-- 2013-09-27 11:00:12|000 --%>
<jsp:useBean id="testDate1100" class="java.util.Date" scope="page" />
<jsp:setProperty name="testDate1100" property="year" value="113"/>
<jsp:setProperty name="testDate1100" property="month" value="8"/>
<jsp:setProperty name="testDate1100" property="date" value="27"/>
<jsp:setProperty name="testDate1100" property="hours" value="11"/>
<jsp:setProperty name="testDate1100" property="minutes" value="00"/>
<jsp:setProperty name="testDate1100" property="seconds" value="12"/>
<li class="media row padding-large-bottom" data-entando-timestamp="<fmt:formatDate value="${testDate1100}" pattern="yyyy-MM-dd HH:mm:ss" />|000">
	<div class="col-xs-12 col-sm-2 col-lg-1 margin-small-bottom activity-stream-picture">
		<img alt=" " src="/portalexample/do/user/avatar/avatarStream.action?gravatarSize=56&amp;username=admin" width="56" height="56" class="img-circle media-object">
	</div>
	<div class="media-body col-xs-12 col-sm-10 col-lg-11 activity-stream-event event-first">
		<div class="popover right display-block" data-entando="ajax-update">
			...
			<a href="/portalexample/do/userprofile/view.action?username=admin" title="label.viewProfile: admin">NAme&amp;</a>
			 ·
			created a new page wewewew:
			<a href="/portalexample/do/Page/edit.action?selectedNode=errorpage">System Error wewewew</a>
				<p class="margin-small-vertical">
					<time datetime="<fmt:formatDate value="${testDate1100}" pattern="yyyy-MM-dd HH:mm" />" title="<fmt:formatDate value="${testDate1100}" pattern="yyyy-MM-dd HH:mm:ss" />" class="text-info">
						<fmt:formatDate value="${testDate1100}" pattern="yyyy-MM-dd HH:mm:ss" />|000 | <c:out value="${random}" />
					</time>
					 ·
					<c:set var="randomLike"><%= java.lang.Math.round(java.lang.Math.random() * 99) %></c:set>
					<c:out value="${randomLike}" />&#32;like(s)
		...
		<div class="padding-base-left" style="margin-left: 20px" data-entando="ajax-update">
			...
			<c:forEach begin="0" end="0" varStatus="commentStatus">
				<div class="media" data-entando-comment="<%= java.lang.Math.round(java.lang.Math.random() * 9999999) %><%= java.lang.Math.round(java.lang.Math.random() * 7) %><%= java.lang.Math.round(java.lang.Math.random() * 7) %><%= java.lang.Math.round(java.lang.Math.random() * 7) %><%= java.lang.Math.round(java.lang.Math.random() * 7) %><%= java.lang.Math.round(java.lang.Math.random() * 7) %><%= java.lang.Math.round(java.lang.Math.random() * 7) %><%= java.lang.Math.round(java.lang.Math.random() * 7) %><%= java.lang.Math.round(java.lang.Math.random() * 7) %><%= java.lang.Math.round(java.lang.Math.random() * 7) %>">
					<a class="pull-left" href="/portalexample/do/userprofile/view.action?username=username-<c:out value="${commentStatus.count}" />" title="label.viewProfile: display name <c:out value="${commentStatus.count}" />">
					...
					<div class="media-body">
						<h5 class="media-heading">
							<a href="/portalexample/do/userprofile/view.action?username=username-<c:out value="${commentStatus.count}" />" title="label.viewProfile: display name <c:out value="${commentStatus.count}" />">display name <c:out value="${commentStatus.count}" /></a>,&#32;
								<time datetime="2013-12-13 16:19" title="2013-12-13 16:19" class="text-info">in an instant</time title="Remove this comment">
							<a href="#remove" data-entando="remove-comment-ajax" class="pull-right">
								<span class="icon fa fa-icon fa-times-circle-o"></span>
								&nbsp;Delete
							</a>
